...
class AttributeAPIController extends AppBaseController
{
    ...
    public function store(CreateAttributeAPIRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new AttributeResource($attribute), 'Attribute saved successfully');
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new AttributeResource($attribute), 'Attribute retrieved successfully');
    }
    ...
    public function update($id, UpdateAttributeAPIRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new AttributeResource($attribute), 'Attribute updated successfully');
    }
